...
export class MyApp {
	...
	initializeApp() {
		this.pltfrm.ready().then(() => {
			...
			this.localstorage.setLocalValue('DefaultSyncStart','2019-08-19T17:00:01Z');		// Use with next publish

			// Set user sync starting point here.
			this.localstorage.setLocalValue('UserSyncStart','2019-08-19T00:00:01Z');
